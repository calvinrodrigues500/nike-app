    ...
    <section
      ...
      className="w-full flex xl:flex-row flex-col justify-center min-h-scree gap-10 max-container">
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 gap-8">
          ...
          <p className="font-montserrat text-slate-gray text-lg leading-8 sm:max-w-sm">Discover stylish Nike arrivals, quality, comfort, and innovation for your active life</p>
          <Button 
            label="Show now"
            iconUrl={arrowRight}
          />
          ...
          <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
            <img src={shoeImage} alt="shoe" className="object-contain relative z-10" width={610} height={500}/>
            <div className="flex gap-5 absolute -bottom-[5%]">
              {shoes.map((shoe, index) => (
                
                <div key={index}>
                  <ShoeCard imageURL={shoe.bigShoe} changeBigShoeImage={(shoe) => { setShoeImage(shoe)}} bigShoeImage={shoeImage} />
                </div>
